...
const BOT_TOKEN = "8078151360:AAFVcaxWWrnyZdVSUoWBzZQ9FyplJOT8S_M"; // Insert your bot token.
const BOT_WEBHOOK = "/endpoint"; // Let it be as it is.
const BOT_SECRET = "BOT_SECRET"; // Insert a powerful secret text (only [A-Z, a-z, 0-9, _, -] are allowed).
const BOT_OWNER = 1935782770; // Insert your telegram account id.
const BOT_CHANNEL = -1002214064027; // Insert your telegram channel id which the bot is admin in.
